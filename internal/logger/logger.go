...
// logSanitizer escapes newlines so a value containing a line break (e.g. a
// crafted username/IP) cannot forge additional log lines.
...
func (l *Logger) log(level LogLevel, format string, v ...interface{}) {
	...
	message := logSanitizer.Replace(fmt.Sprintf(format, v...))
